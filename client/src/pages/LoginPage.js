  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        <div className="auth-switch">Don't have an account? <Link to="/register">Sign up free</Link></div>
      </div>
    </div>
  );
}
      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input className="form-input" type="password" placeholder="Create password" value={form.password} onChange={e => setForm(f => ({ ...f, password: e.target.value }))} required />
          </div>
          <button className="btn btn-primary" style={{ width: '100%', justifyContent: 'center', padding: 13 }} disabled={loading}>
